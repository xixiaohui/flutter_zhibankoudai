class ModuleConfig {
  ...
  const ModuleConfig({required this.version, required this.modules});
}
...
class Tags {
  ...
  const Tags({required this.category, required this.ai});
}
...
class Category {
  ...
  const Category({required this.field, required this.icon});
}
...
const defaultModuleConfig = ModuleConfig(
  ...
  modules: [
    Module(
      ...
      tags: Tags(
        category: Category(field: 'author', icon: 'authorIcon'),
        ai: 'AI',
      ),
      aiTags: ['名言', '金句'],
      refreshText: '换一句',
    ...
    Module(
      ...
      tags: Tags(
        category: Category(field: 'category', icon: 'categoryIcon'),
        ai: 'AI',
      ),
      aiTags: ['段子', '幽默'],
      refreshText: '换一个',
    ...
    Module(
      ...
      tags: Tags(
        category: Category(field: 'hexagram', icon: 'hexagramIcon'),
        ai: 'AI',
      ),
      aiTags: ['易经', '卦象'],
      refreshText: '再算一卦',
